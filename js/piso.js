function init(){
    ...
    let option1Text =document.createTextNode("Piso 1");
    option1.appendChild(option1Text);

    let option2=document.createElement("option");
    option2.setAttribute("value", "value2");
    let option2Text =document.createTextNode("Piso 2");
    option2.appendChild(option2Text);

    let option3=document.createElement("option");
    option3.setAttribute("value", "value3");
    let option3Text =document.createTextNode("Piso 3");
    ...
    optionDL1.setAttribute("value", "piso 1");

    let optionDL2 = document.createElement ("option");
    optionDL2.setAttribute("value", "piso 2");

    let optionDL3 = document.createElement ("option");
    optionDL3.setAttribute("value", "piso 3");
